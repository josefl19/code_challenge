...
describe("Test class StudentsController", () => {
    test("Testing getAllStudents", () => {
    ...
    test("Testing getStudentsWithCertification", () => {
        const studentWithCertification = StudentController.getStudentsWithCertification();
        expect(studentWithCertification).toStrictEqual([
    ...
    test("Testing getStudentsWithMoreOf500Credits method", () => {
        const studentsCredits = StudentController.getStudentsWithMoreOf500Credits(800);
        expect(studentsCredits).toStrictEqual([
            "Phillips",
            "Mindy",
            "Kara",
            "Cora",
